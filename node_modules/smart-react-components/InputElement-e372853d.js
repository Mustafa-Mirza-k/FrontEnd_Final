...
var Input = styled__default(Input$1.Input).attrs(({ as, size$ = "default", type$ = "gray", border$ = true, shape = "default", inputElement = true, flex = "1 1 auto", display = "block", width = "100%", fontFamily = "inherit" }) => ({
    customKeys,
    ...
    fontFamily,
    inputElement
}))(({ theme, type$, fill$, border$, shape, disabled, leftAddon, leftAddonAbsolute, rightAddon, rightAddonAbsolute, inputElement }) => `
