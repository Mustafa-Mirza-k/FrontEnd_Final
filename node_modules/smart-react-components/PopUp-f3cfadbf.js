...
var Element$1 = require('./Element-a54cdab9.js');
...
const Modal = ({ children, overlayClick = true, overlayProps = index.DV.JSX_ELEMENT_PROPS, modalElementProps = index.DV.JSX_ELEMENT_PROPS, size = "default", centered, minWidth, maxWidth, status = true, setStatus, transitionClassName = "src-overlay-modal-down", transitionType, transitionDuration = 300, showAnimation = true, hideAnimation = true, beforeOpen, afterOpen, beforeClose, afterClose }) => {
    ...
    return (React__default.createElement(CSSTransition.CSSTransition, { status: status, className: transitionClassName, type: transitionType, duration: transitionDuration, showAnimation: showAnimation, hideAnimation: hideAnimation, beforeShow: beforeOpen, afterShow: afterOpen, beforeHide: beforeClose, afterHide: afterClose },
        React__default.createElement(Overlay.Overlay, Object.assign({}, overlayProps, { elementProps: Object.assign(Object.assign({}, overlayProps.elementProps), { onMouseUp: clickOverlay, onTouchEnd: clickOverlay }), ref: overlayEl }),
            React__default.createElement(Element$1.ModalElement, Object.assign({ alignSelf: centered ? "center" : "flex-start" }, modalElementProps, { minWidthMd: minWidth || theme.modal.width[size], maxWidth: maxWidth || theme.modal.width[size] }), children))));
};

const OVERLAY_PROPS = {
    background: theme.isMobile
};
const Popup = ({ children, modalElementProps = index.DV.JSX_ELEMENT_PROPS, overlayProps = OVERLAY_PROPS, status, setStatus, beforeOpen, beforeClose, afterOpen, afterClose, transitionClassName, transitionType, transitionDuration, showAnimation, hideAnimation }) => {
    return (React__default.createElement(Modal, { modalElementProps: modalElementProps, overlayProps: overlayProps, overlayClick: false, status: status, setStatus: setStatus, beforeOpen: beforeOpen, beforeClose: beforeClose, afterOpen: afterOpen, afterClose: afterClose, transitionClassName: transitionClassName, transitionType: transitionType, transitionDuration: transitionDuration, showAnimation: showAnimation, hideAnimation: hideAnimation }, children));
};
