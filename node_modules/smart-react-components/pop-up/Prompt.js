...
const Prompt = ({ modalElementProps, overlayProps, type = "primary", title, message, placeholder, value, callback, lang = DEFAULT_LANGUAGE, status, setStatus, transitionClassName, transitionDuration, transitionType, showAnimation, hideAnimation, beforeOpen, beforeClose, afterOpen, afterClose }) => {
    ...
    return (React__default.createElement(PopUp.PopUp, { modalElementProps: modalElementProps, overlayProps: overlayProps, status: status, transitionClassName: transitionClassName, transitionDuration: transitionDuration, transitionType: transitionType, showAnimation: showAnimation, hideAnimation: hideAnimation, beforeOpen: beforeOpen, beforeClose: beforeClose, afterOpen: afterOpen$, afterClose: afterClose },
        ...
        React__default.createElement(Body.ModalBody, null,
            React__default.createElement("p", null, message),
            React__default.createElement(InputElement.Input, { defaultValue: value || "", placeholder: placeholder || "", ref: inputEl })),
        React__default.createElement(Footer.ModalFooter, { pt: [0, true] },
            React__default.createElement(Button.Button, { type: type, link: DOMHelper.DOMHelper.isMobile, waveEffect: DOMHelper.DOMHelper.isMobile ? "dark" : "light", elementProps: { onClick: (() => close(false)) } }, lang.cancel),
            React__default.createElement(Button.Button, { type: type, fill: false, link: DOMHelper.DOMHelper.isMobile, waveEffect: DOMHelper.DOMHelper.isMobile ? "dark" : "light", elementProps: { onClick: (() => close(true)) } }, lang.ok))));
};
