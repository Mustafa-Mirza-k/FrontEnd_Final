...
const Confirm = ({ modalElementProps, overlayProps, type = "primary", title, message, callback, lang = DEFAULT_LANGUAGE, status, setStatus, transitionClassName, transitionDuration, transitionType, showAnimation, hideAnimation, beforeOpen, beforeClose, afterOpen, afterClose }) => {
